...
\textsc{Clerk} Sally Jones & \textsc{Worship} Julie Kirklin\\
\textsc{Care} Cheryl Flaherty & \textsc{Adult} Brad Rodgers \\
\textsc{Children} Colleen Massoth & \textsc{Youth} Melanie Graham \\
\textsc{Property} Joe Songer & \textsc{Outreach} James Martin \\
\textsc{At-Large} Bill Eidson & \textsc{At-Large} Wes Russell \\
\end{tabular}
