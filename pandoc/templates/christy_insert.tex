\documentclass[landscape,twocolumn,letterpaper,10pt]{article} % Font size (10pt, 11pt or 12pt)

% more margin settings

\setlength{\oddsidemargin}{0in}		% default=0in
\setlength{\textwidth}{9in}		% default=9in

\setlength{\columnsep}{2in}		% default=10pt
\setlength{\columnseprule}{0pt}		% default=0pt (no line)

\setlength{\textheight}{5.85in}		% default=5.15in
\setlength{\topmargin}{.2in}		% default=0.20in
...
\par{\color{sign}\centering{\scshape\LARGE $title$}

\raggedright{\color{text1} $body$}



{\color{sign}\fontspec[Variant = 2]{Zapfino} $author$}
