...
\usepackage[papersize={8.5in,5.5in}, hmargin=1.25cm, vmargin=0.75cm]{geometry} % Specifies horizontal and vertical page margins
...
\namesection{$number$}{$project$ Project}{
Coordinator: $coordinatior$ \textbullet{} $c-email$ \textbullet{} $c-phone$
}
...
$if(what-to-bring)$
$for(what-to-bring)$ $what-to-bring$ $sep$\textbullet{} $endfor$
$else$
Just bring yourself
$endif$
